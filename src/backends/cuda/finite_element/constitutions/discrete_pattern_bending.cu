...
#include <finite_element/constitutions/discrete_pattern_bending_function.h>
#include <numbers>
...
{
class DiscretePatternBending final : public FiniteElementExtraConstitution
{
    static constexpr U64 DiscretePatternBendingUID = 67;
    using Base = FiniteElementExtraConstitution;

  public:
    using Base::Base;
    U64 get_uid() const noexcept override { return DiscretePatternBendingUID; }
    ...
    {
        namespace DSB = sym::discrete_pattern_bending;
...
REGISTER_SIM_SYSTEM(DiscretePatternBending);
}  // namespace uipc::backend::cuda
